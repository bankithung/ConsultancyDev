...
def build_catalog():
    ...
    standalone = [
        ...
        {'path': 'role-permissions/', 'method': 'GET', 'permission': 'IsCompanyAdmin (company or platform admin)', 'throttle': '',
        ...
        {'path': 'role-permissions/', 'method': 'PUT', 'permission': 'IsCompanyAdmin (company or platform admin)', 'throttle': '',
        ...
        {'path': 'role-permissions/', 'method': 'DELETE', 'permission': 'IsCompanyAdmin (company or platform admin)', 'throttle': '',
